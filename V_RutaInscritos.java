...
public class V_RutaInscritos extends JPanel {
	...
	public V_RutaInscritos() {
        ...
        comboBoxA.addItem("Ruta X");
        comboBoxA.addItem("Ruta O");
        comboBoxA.addItem("Ruta F");
        comboBoxA.addItem("Ruta Y");
		...
		Object[] fila_ejemplo= {new ImageIcon(getClass().getClassLoader().getResource("presentacion/iconFilaFox.png")), "Adrián", "Ruiz Esteban", "Ruta X", "05724093Z", "666-666-666", "Pagado", "mi_usuario@ejemplo.com", "Nada."};
		modeloTabla.aniadeFila(fila_ejemplo);
		
	}

	class MiModeloTabla extends AbstractTableModel {
		private String[] nombreColumnas = { "Foto", "Nombre", "Apellidos", "Ruta", "DNI", "Teléfono", "Pago",
