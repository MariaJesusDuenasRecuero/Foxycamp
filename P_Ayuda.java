...
public class P_Ayuda extends JFrame {
	...
	public P_Ayuda() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(P_Ayuda.class.getResource("/presentacion/servicio-al-cliente.png")));
		setTitle("Ayuda");
		setResizable(false);
		...
		JLabel lblNewLabel_2 = new JLabel("Atención al cliente");
