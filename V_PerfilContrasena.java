...
public class V_PerfilContrasena extends JPanel {
	...
	public V_PerfilContrasena() {
		...
		gbl_panel.rowHeights = new int[]{0, 54, 0, 41, 0, 50, 0, 0, 50, 0, 0, 50, 0, 0, 0};
		...
		lblCambioDeContrasea.setForeground(new Color(255, 140, 0));
		...
		btnCambiarContrasea.setBackground(new Color(244, 164, 96));
		GridBagConstraints gbc_btnCambiarContrasea = new GridBagConstraints();
		gbc_btnCambiarContrasea.gridheight = 2;
		...
		gbc_btnCambiarContrasea.insets = new Insets(0, 0, 5, 5);
